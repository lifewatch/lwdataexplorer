...
if (!require("lwdataexplorer", character.only = TRUE)) {
      devtools::install_github("lifewatch/lwdataexplorer", upgrade = FALSE)
}
```
<!-- Insert image  -->
...
- Geographical coverage: [Oostende Harbour](https://www.marineregions.org/gazetteer.php?p=details&id=5476), [Belgian Exclusive Economic Zone](https://www.marineregions.org/gazetteer.php?p=details&id=3293).
