...
* **VolumeC**: A proxy to calculate densities of zooplankton; VolumeC is an exact depth in meters at that sampling point, as measured by the Underway system of the research vessel.
* **VolumeE**: Standard depth in meters of the station being sampled.
* **VolumeM**: A proxy to calculate densities of zooplankton. Units are m<sup>3</sup>. 
...
The full methodology is described in a datapaper:  Mortelmans, J.; Goossens, J.; Amadei Martínez, L.; Deneudt, K.;  Cattrijsse, A.; Hernandez, F. (2019). LifeWatch observatory date:  zooplankton observations in the Belgian part of the North Sea.  Geoscience Data Journal: 1-9. [https://hdl.handle.net/10.1002/gdj3.68](https://hdl.handle.net/10.1002/gdj3.68).
...
In addition, a fixed dataset is available via: “Flanders Marine Institute (VLIZ), Belgium (2021): LifeWatch observatory data: zooplankton observations in the Belgian Part of the North Sea. [https://doi.org/10.14284/445](https://doi.org/10.14284/445)
