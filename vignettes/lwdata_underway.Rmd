...
* **ChlorophylA**: Concentration of Chlorophyll A, based on fluoresence, expressed in µg/L.
* **SpeedMadeGood**: Corrected speed of the research vessel, measured in knots.
* **Speedlog**: Speed of the research vessel, measured in knots.
* **TrueWindDir**: Direction of the wind in deg.
* **TrueWindSpeed**: Speed of the wind in m/s.
* **CourseMadeGood**: Corrected course of the research vessel, measured in degree.
* **Gyro**: .
