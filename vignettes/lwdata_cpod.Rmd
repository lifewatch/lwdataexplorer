...
### Query options
* **Processing**: Type of data: Raw
* **Timeframe**: Starting and stopping date for the query.
* **Quality**:  Level of processing: default Hi+Mod.
* **Sample period**: Counts aggregated. Currently only per minute with processing = Raw.
